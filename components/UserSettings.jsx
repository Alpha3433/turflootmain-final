...
const UserSettings = ({ isOpen, onClose, user }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm">
      ...
      <div className="hidden md:block relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl max-w-4xl w-full max-h-[85vh] overflow-hidden border border-orange-500/30 shadow-2xl">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Customize your TurfLoot experience</p>
              </div>
            </div>
