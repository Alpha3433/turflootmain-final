...
export default function PartyLobbySystem({ 
  ...
  // Fetch party invitations (moved here to fix hoisting issue)
  ...
  const inviteFriend = async (friendId, friendUsername) => {
    ...
    try {
      const response = await fetch(`${getApiUrl('/party-api/invite')}`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const declineInvitation = async (invitationId) => {
    ...
    try {
      const response = await fetch(`${getApiUrl('/party-api/decline-invitation')}`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          invitationId,
