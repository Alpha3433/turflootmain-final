...
function testWebSocketURLGeneration() {
    ...
    process.env.NEXT_PUBLIC_BASE_URL = 'https://agario-multiplayer.preview.emergentagent.com';
    ...
    // Validation tests
    const tests = {
        'Environment Variable Read': baseUrl === 'https://agario-multiplayer.preview.emergentagent.com',
    ...
    const scenarios = [
        { name: 'Production HTTPS', url: 'https://agario-multiplayer.preview.emergentagent.com', expectedWS: 'wss:' },
