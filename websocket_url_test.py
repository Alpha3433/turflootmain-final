...
function testWebSocketURLGeneration() {
    ...
    process.env.NEXT_PUBLIC_BASE_URL = 'https://smooth-mover.preview.emergentagent.com';
    ...
    // Validation tests
    const tests = {
        'Environment Variable Read': baseUrl === 'https://smooth-mover.preview.emergentagent.com',
    ...
    const scenarios = [
        { name: 'Production HTTPS', url: 'https://smooth-mover.preview.emergentagent.com', expectedWS: 'wss:' },
