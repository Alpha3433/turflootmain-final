...
function testWebSocketURLGeneration() {
    ...
    process.env.NEXT_PUBLIC_BASE_URL = 'https://battle-rewards-13.preview.emergentagent.com';
    ...
    // Validation tests
    const tests = {
        'Environment Variable Read': baseUrl === 'https://battle-rewards-13.preview.emergentagent.com',
    ...
    const scenarios = [
        { name: 'Production HTTPS', url: 'https://battle-rewards-13.preview.emergentagent.com', expectedWS: 'wss:' },
