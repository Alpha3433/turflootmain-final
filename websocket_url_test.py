...
function testWebSocketURLGeneration() {
    ...
    process.env.NEXT_PUBLIC_BASE_URL = 'https://privy-arena.preview.emergentagent.com';
    ...
    // Validation tests
    const tests = {
        'Environment Variable Read': baseUrl === 'https://privy-arena.preview.emergentagent.com',
    ...
    const scenarios = [
        { name: 'Production HTTPS', url: 'https://privy-arena.preview.emergentagent.com', expectedWS: 'wss:' },
