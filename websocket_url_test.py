...
function testWebSocketURLGeneration() {
    ...
    process.env.NEXT_PUBLIC_BASE_URL = 'https://gameloop-migrate.preview.emergentagent.com';
    ...
    // Validation tests
    const tests = {
        'Environment Variable Read': baseUrl === 'https://gameloop-migrate.preview.emergentagent.com',
    ...
    const scenarios = [
        { name: 'Production HTTPS', url: 'https://gameloop-migrate.preview.emergentagent.com', expectedWS: 'wss:' },
