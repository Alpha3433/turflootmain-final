...
# Retrieve name  
curl "https://game-server-hub-5.preview.emergentagent.com/names-api/get?userId=test"
...
```bash
# Notifications count
curl -X POST "https://game-server-hub-5.preview.emergentagent.com/friends-api/notifications/count" \
  -d '{"userId": "test"}'
# Result: {"count":0,"timestamp":"2025-08-28T17:42:44.532Z"}

# Mark notifications as read
curl -X POST "https://game-server-hub-5.preview.emergentagent.com/friends-api/notifications/mark-read" \
  -d '{"userId": "test"}'
