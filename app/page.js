            ...
            <div style={{ padding: '24px' }}>
              ...
              <div style={{ marginBottom: '20px' }}>
                <label style={{
                  ...
                  Invite Friends ({friendsList.filter(f => f.status === 'accepted').length} Available)
                </label>
                <div style={{
                  maxHeight: '150px',
                  overflowY: 'auto',
                  ...
                  {friendsList.filter(f => f.status === 'accepted').length > 0 ? (
                      ...
                      <div key={friend.id} style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                          <div style={{
                            ...
                            borderRadius: '50%',
                            background: friend.isOnline ? '#22c55e' : '#6b7280',
                            boxShadow: friend.isOnline ? '0 0 6px rgba(34, 197, 94, 0.6)' : 'none'
                          }} />
                          <span style={{
                            color: friend.isOnline ? '#e2e8f0' : '#9ca3af',
                            fontSize: '14px',
                    ...
                    <div style={{
                      ...
                      <div>No friends available to invite</div>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '12px', marginTop: '24px' }}>
                ...
                <button
                  onClick={() => {
                    ...
                    alert('🎯 Party creation coming soon!')
                    setIsCreatePartyModalOpen(false)
                  }}
                  style={{
                    flex: 1,
