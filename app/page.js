        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center px-4 sm:px-8 py-2 sm:py-0 sm:h-16">
          ...
          <div className="flex items-center justify-between w-full sm:w-auto space-x-2 sm:space-x-3">
            ...
            {showLobby && authenticated && user && (
              <div className="absolute top-full right-0 mt-2 w-80 bg-gray-800/95 backdrop-blur-sm border border-orange-500/40 rounded-xl shadow-2xl z-50 overflow-hidden">
                ...
                {!currentLobby ? (
                          ...
                          <div key={index} className="flex items-center justify-between p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                            <div className="flex items-center space-x-3">
                              <div className="w-8 h-8 bg-yellow-500/20 rounded-full flex items-center justify-center text-yellow-400 font-bold text-sm">
                                {invite.from.substring(0, 1).toUpperCase()}
                              </div>
                              <div>
                                <div className="text-white font-medium text-sm">{invite.from}</div>
                                <div className="text-gray-400 text-xs">{invite.roomType} room</div>
                              </div>
                            </div>
                            <div className="flex items-center space-x-2">
                              <button className="px-3 py-1 bg-green-600 hover:bg-green-700 text-white text-xs font-medium rounded transition-colors">
                                Accept
                              </button>
                              <button className="px-3 py-1 bg-gray-600 hover:bg-gray-700 text-white text-xs font-medium rounded transition-colors">
                                Decline
                              </button>
                            </div>
                          </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {[
                          ...
                          <button 
                            key={room.amount}
                            onClick={() => {/* TODO: Quick join room */}}
                            className={`p-3 bg-${room.color}-600/20 border border-${room.color}-500/40 hover:bg-${room.color}-600/30 rounded-lg transition-all duration-200 group`}
                          >
                            <div className={`text-${room.color}-400 font-bold text-sm`}>{room.amount}</div>
                            <div className="text-gray-400 text-xs">Solo Play</div>
                          </button>
                        ))}
                      </div>
                    </div>
                  ...
                  <div className="p-4 space-y-4">
                      ...
                      {lobbyMembers.map((member, index) => (
                        <div key={index} className="flex items-center space-x-3 p-2 bg-gray-700/50 rounded-lg">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="text-gray-400 text-xs">Balance: ${member.balance}</div>
                          </div>
                          {member.isLeader && (
                    ...
                    {/* Invite Friends */}
                    <button className="w-full p-3 border border-orange-500/40 hover:bg-orange-500/10 text-orange-400 hover:text-orange-300 rounded-lg transition-all duration-200 text-sm font-medium">
                      + Invite Friends
                    </button>
                    ...
                    <div className="flex space-x-2 pt-2 border-t border-gray-700/50">
                      <button className="flex-1 px-4 py-2 bg-red-600/20 border border-red-500/40 hover:bg-red-600/30 text-red-400 hover:text-red-300 rounded-lg transition-all duration-200 text-sm font-medium">
                        Leave Party
                      </button>
                      <button className="flex-1 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-all duration-200 text-sm font-medium">
                        Start Game
                      </button>
                    </div>
                  </div>
