...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative">
      ...
      {/* Main App Section - Below the fold */}
      <section className="relative z-10 bg-black">
        {/* Top header for main app */}
        <header className="flex items-center justify-between p-6 bg-black/80 backdrop-blur-sm border-b border-yellow-500/20">
        ...
        <div className="flex min-h-screen">
          ...
          {/* Center content - Game lobby area */}
          <div className="flex-1 flex flex-col items-center justify-center p-8 space-y-8">
            <div className="text-center space-y-4">
              <h2 className="text-4xl font-bold text-yellow-500">Game Lobby</h2>
              <p className="text-xl text-gray-300">Select your game mode and start playing!</p>
            </div>
        ...
        {/* Discord button */}
        <Button className="fixed bottom-6 left-6 bg-indigo-600 hover:bg-indigo-500 z-50" size="sm">
          Join Discord
        </Button>
      </section>
