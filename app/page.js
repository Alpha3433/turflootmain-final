...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white relative overflow-hidden flex flex-col">
      ...
      <header className="sticky top-0 z-50 h-16 w-full backdrop-blur-sm bg-black/20 border-b border-gray-700/30" style={{
      ...
      {/* Skill Disclaimer Banner - Below nav, specific colors */}
      <div className="h-6 px-4 text-center flex items-center justify-center relative z-40" style={{
        backgroundColor: '#083F26',
        color: '#FFD54F',
        fontSize: '11px'
      }}>
        <span>⚠️ TurfLoot prizes are determined solely by player skill. Play responsibly.</span>
      </div>

      {/* Main Content - Vertically Centered */}
      <main className="flex-1 flex items-center justify-center py-8">
        <div className="w-full max-w-[1200px] mx-auto px-4">
          {/* Desktop: 12-column grid with row gap 40px */}
          <div className="grid grid-cols-1 md:grid-cols-6 xl:grid-cols-12 gap-4 xl:gap-y-10">
            
            {/* TOP ROW */}
            
            {/* LEFT STACK - Leaderboard (Top Row) */}
            ...
            {/* CENTER HERO - Main Game Interface (Top Row) */}
            <div className="md:col-span-6 xl:col-span-4 order-first md:order-none xl:order-none">
              <div className="text-center space-y-6">
                {/* Hero Title */}
                <div className="mb-6">
                  <h1 className="text-4xl md:text-5xl xl:text-6xl font-black tracking-tight mb-3">
                  ...
                  <p className="text-gray-300 text-lg md:text-xl font-bold tracking-wide mb-2">
                ...
                <div className="flex justify-center space-x-4 md:space-x-6 mb-6">
                  <div className="pulse-live text-center bg-black/40 backdrop-blur-md px-4 md:px-6 py-4 rounded-[24px] border border-gray-700/50 shadow-2xl">
                    <div className="text-2xl md:text-3xl font-black bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-1">
                      {livePlayerCount}
                    </div>
                    <div className="text-gray-400 text-xs md:text-sm font-medium">Players in Game</div>
                  </div>
                  <div className="pulse-live text-center bg-black/40 backdrop-blur-md px-4 md:px-6 py-4 rounded-[24px] border border-gray-700/50 shadow-2xl">
                    <div className="text-2xl md:text-3xl font-black bg-gradient-to-r from-green-400 to-cyan-500 bg-clip-text text-transparent mb-1">
                      ${globalWinnings.toLocaleString()}
                    </div>
                    <div className="text-gray-400 text-xs md:text-sm font-medium">Global Player Winnings</div>
                  </div>
                </div>

                {/* Name Input */}
                <div className="flex justify-center mb-4">
                  <div className="w-full max-w-sm bg-black/40 backdrop-blur-md rounded-[24px] p-3 border border-gray-700/50 flex items-center justify-between shadow-2xl">
                    <div className="flex items-center space-x-3 flex-1">
                      <div className="w-8 h-8 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-xl flex items-center justify-center text-sm font-bold text-black">
                        {authenticated && user ? (
                      ...
                      {isEditingName ? (
                        <div className="flex-1 flex items-center space-x-2">
                          <input
                            ...
                            autoFocus
                            className="bg-gray-800/60 text-white text-sm font-medium px-3 py-1.5 rounded-xl border border-gray-600/50 focus:border-yellow-400/50 focus:outline-none flex-1"
                            maxLength={20}
                          />
                          <button
                            onClick={handleNameSave}
                            className="p-1.5 bg-green-600/20 hover:bg-green-600/30 border border-green-500/30 rounded-lg text-green-400 font-bold transition-all"
                          >
                            ✓
                          </button>
                          <button
                            onClick={handleNameCancel}
                            className="p-1.5 bg-red-600/20 hover:bg-red-600/30 border border-red-500/30 rounded-lg text-red-400 font-bold transition-all"
                          >
                            ✕
                          </button>
                        </div>
                        ...
                        <span 
                          className={`text-gray-300 text-sm font-medium flex-1 ${
                            authenticated && user ? 'cursor-pointer hover:text-white hover:bg-gray-700/30 px-2 py-1 rounded-lg transition-all' : ''
                          }`}
            ...
            <div className="md:col-span-3 xl:col-span-4">
              <div className="bg-black/40 backdrop-blur-md rounded-[24px] p-6 border border-gray-700/50 shadow-2xl">
                ...
                <div className="text-center py-4">
                  ...
                  <div className="text-gray-400 text-sm mb-4">SOL Balance</div>
                  
                  <div className="space-y-3">
                    <button className="w-full py-2.5 bg-green-600/20 hover:bg-green-600/30 border border-green-500/30 rounded-xl text-green-400 font-bold text-sm transition-all hover:scale-105">
                      Add Funds
                    </button>
                    <button className="w-full py-2.5 bg-orange-600/20 hover:bg-orange-600/30 border border-orange-500/30 rounded-xl text-orange-400 font-bold text-sm transition-all hover:scale-105">
                      Cash Out
                    </button>
                  </div>
                </div>
            ...
            <div className="md:col-span-3 xl:col-span-4">
              <div className="bg-black/40 backdrop-blur-md rounded-[24px] p-6 border border-gray-700/50 shadow-2xl">
                ...
                <div className="text-center py-6">
                  ...
                  <div className="text-gray-400 text-sm mb-4">No friends... add some!</div>
                  <button className="px-4 py-2 bg-blue-600/20 hover:bg-blue-600/30 border border-blue-500/30 rounded-xl text-blue-400 font-bold text-sm transition-all hover:scale-105">
                    Add Friends
                  </button>
                </div>
              </div>
            ...
            <div className="md:col-span-6 xl:col-span-4">
              <div className="space-y-6">
                ...
                <div className="flex justify-center space-x-3">
                  {[1, 5, 20].map((amount) => (
                    <button
                      ...
                      className={`px-6 py-3 rounded-[24px] font-bold text-lg transition-all duration-300 hover:scale-105 shadow-2xl ${
                        selectedBet === amount
                ...
                <div className="hidden md:block">
                  <button className="w-full h-14 bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-400 hover:from-yellow-300 hover:via-orange-400 hover:to-yellow-300 text-black rounded-[24px] font-black text-xl shadow-2xl transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-3">
                ...
                {/* Game Options */}
                <div className="flex justify-center space-x-3">
                  <button className="px-4 py-2.5 bg-gray-800/60 backdrop-blur-sm hover:bg-gray-700/60 rounded-[24px] text-sm font-bold border border-gray-600/50 transition-all hover:scale-105">
                    Quick Match
                  </button>
                  <button className="px-4 py-2.5 bg-gray-800/60 backdrop-blur-sm hover:bg-gray-700/60 rounded-[24px] text-sm font-bold border border-gray-600/50 transition-all hover:scale-105">
                    Browse Lobbies
                ...
                <div className="flex justify-center space-x-3 pt-2">
                  ...
                  <button className="px-4 py-2.5 bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-500 hover:to-blue-500 rounded-[24px] font-bold text-sm flex items-center space-x-2 transition-all hover:scale-105 shadow-lg">
            ...
            <div className="md:col-span-3 xl:col-span-4">
              <div className="bg-black/40 backdrop-blur-md rounded-[24px] p-6 border border-gray-700/50 shadow-2xl">
                ...
                <div className="text-center">
                  <div className="w-14 h-14 bg-gradient-to-br from-blue-400 to-cyan-500 rounded-full mx-auto mb-4 flex items-center justify-center shadow-lg">
                    <div className="w-10 h-10 bg-white rounded-full relative">
                      <div className="absolute top-2 left-2 w-1.5 h-1.5 bg-blue-600 rounded-full"></div>
                      <div className="absolute top-2 right-2 w-1.5 h-1.5 bg-blue-600 rounded-full"></div>
                      <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 w-3 h-1 bg-blue-600 rounded-full"></div>
                    </div>
                  </div>
                  <button className="px-4 py-2 bg-purple-600/20 hover:bg-purple-600/30 border border-purple-500/30 rounded-xl text-purple-400 font-bold text-sm transition-all hover:scale-105">
                    Change Appearance
                  </button>
                </div>
              </div>
