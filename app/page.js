            ...
            <div className="col-span-12 lg:col-span-6 flex flex-col justify-center space-y-8">
              ...
              <div className="flex justify-center space-x-12">
                <div className="text-center">
                  <div className="text-4xl font-black text-yellow-400 mb-1">{livePlayerCount}</div>
                  <div className="text-gray-400 text-sm font-medium">Players in Game</div>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-black text-yellow-400 mb-1">${globalWinnings.toLocaleString()}</div>
