        ...
        <>
          ...
          {!showOrientationGate && !isGameOver && (
            <>
              ...
              >
                <div className={`w-full h-full bg-black/90 rounded-full border border-gray-600/30 flex items-center justify-center transition-all duration-300 ${
