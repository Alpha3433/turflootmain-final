        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              borderRadius: '50%',
              left: `${((minimapData.playerX - 2000) / (gameRef.current?.currentPlayableRadius || 2500)) * (isMobile ? 57.5 : 105) + (isMobile ? 60.5 : 110)}px`,
              top: `${((minimapData.playerY - 2000) / (gameRef.current?.currentPlayableRadius || 2500)) * (isMobile ? 57.5 : 105) + (isMobile ? 60.5 : 110)}px`,
            ...
            {minimapData.enemies.map((enemy, i) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: '50%',
                  left: `${((enemy.x - 2000) / (gameRef.current?.currentPlayableRadius || 2500)) * (isMobile ? 57.5 : 105) + (isMobile ? 60.5 : 110)}px`,
                  top: `${((enemy.y - 2000) / (gameRef.current?.currentPlayableRadius || 2500)) * (isMobile ? 57.5 : 105) + (isMobile ? 60.5 : 110)}px`,
                  transform: 'translate(-50%, -50%)',
