...
const MultiplayerArena = () => {
  ...
  class MultiplayerGameEngine {
    constructor(canvas, inputSender, selectedSkin) {
      ...
      this.maxPlayableRadius = 2500  // Maximum zone radius  
      this.currentPlayableRadius = 2200 // Starting zone size
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              borderRadius: '50%',
              left: `${((minimapData.playerX - 3000) / (gameRef.current?.currentPlayableRadius || 2500)) * (isMobile ? 57.5 : 105) + (isMobile ? 60.5 : 110)}px`,
              top: `${((minimapData.playerY - 3000) / (gameRef.current?.currentPlayableRadius || 2500)) * (isMobile ? 57.5 : 105) + (isMobile ? 60.5 : 110)}px`,
            ...
            {minimapData.enemies.map((enemy, i) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: '50%',
                  left: `${((enemy.x - 3000) / (gameRef.current?.currentPlayableRadius || 2500)) * (isMobile ? 57.5 : 105) + (isMobile ? 60.5 : 110)}px`,
                  top: `${((enemy.y - 3000) / (gameRef.current?.currentPlayableRadius || 2500)) * (isMobile ? 57.5 : 105) + (isMobile ? 60.5 : 110)}px`,
                  transform: 'translate(-50%, -50%)',
