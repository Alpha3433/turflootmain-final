        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              borderRadius: '50%',
              left: `${((minimapData.playerX - 3000) / (gameRef.current?.currentPlayableRadius || 2000)) * (isMobile ? 57.5 : 105) + (isMobile ? 60.5 : 110)}px`,
              top: `${((minimapData.playerY - 3000) / (gameRef.current?.currentPlayableRadius || 2000)) * (isMobile ? 57.5 : 105) + (isMobile ? 60.5 : 110)}px`,
