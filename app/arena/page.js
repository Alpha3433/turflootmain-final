        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              borderRadius: '50%',
              left: `${((minimapData.playerX - 2000) / (gameRef.current?.currentPlayableRadius || 1800)) * (isMobile ? 57.5 : 105) + (isMobile ? 60.5 : 110)}px`,
              top: `${((minimapData.playerY - 2000) / (gameRef.current?.currentPlayableRadius || 1800)) * (isMobile ? 57.5 : 105) + (isMobile ? 60.5 : 110)}px`,
