...
- **Health Check**: `https://tactical-arena-7.preview.emergentagent.com/health` → Returns `{"status":"healthy"}`
- **Name Saving**: `https://tactical-arena-7.preview.emergentagent.com/names-api/update` → Successfully saves names
- **Name Retrieval**: `https://tactical-arena-7.preview.emergentagent.com/names-api/get?userId=X` → Successfully retrieves names
...
# Retrieve name:
curl "https://tactical-arena-7.preview.emergentagent.com/names-api/get?userId=$USER_ID"  
