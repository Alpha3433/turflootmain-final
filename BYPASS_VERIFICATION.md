...
- **Health Check**: `https://milblob-game.preview.emergentagent.com/health` → Returns `{"status":"healthy"}`
- **Name Saving**: `https://milblob-game.preview.emergentagent.com/names-api/update` → Successfully saves names
- **Name Retrieval**: `https://milblob-game.preview.emergentagent.com/names-api/get?userId=X` → Successfully retrieves names
...
# Retrieve name:
curl "https://milblob-game.preview.emergentagent.com/names-api/get?userId=$USER_ID"  
