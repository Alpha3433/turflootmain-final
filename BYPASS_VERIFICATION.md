...
- **Health Check**: `https://realtime-lobby.preview.emergentagent.com/health` → Returns `{"status":"healthy"}`
- **Name Saving**: `https://realtime-lobby.preview.emergentagent.com/names-api/update` → Successfully saves names
- **Name Retrieval**: `https://realtime-lobby.preview.emergentagent.com/names-api/get?userId=X` → Successfully retrieves names
...
# Retrieve name:
curl "https://realtime-lobby.preview.emergentagent.com/names-api/get?userId=$USER_ID"  
