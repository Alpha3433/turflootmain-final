...
- **Health Check**: `https://turfloot-arena-3.preview.emergentagent.com/health` → Returns `{"status":"healthy"}`
- **Name Saving**: `https://turfloot-arena-3.preview.emergentagent.com/names-api/update` → Successfully saves names
- **Name Retrieval**: `https://turfloot-arena-3.preview.emergentagent.com/names-api/get?userId=X` → Successfully retrieves names
...
# Retrieve name:
curl "https://turfloot-arena-3.preview.emergentagent.com/names-api/get?userId=$USER_ID"  
