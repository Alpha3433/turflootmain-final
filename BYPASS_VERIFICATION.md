...
- **Health Check**: `https://agar-military-1.preview.emergentagent.com/health` → Returns `{"status":"healthy"}`
- **Name Saving**: `https://agar-military-1.preview.emergentagent.com/names-api/update` → Successfully saves names
- **Name Retrieval**: `https://agar-military-1.preview.emergentagent.com/names-api/get?userId=X` → Successfully retrieves names
...
# Retrieve name:
curl "https://agar-military-1.preview.emergentagent.com/names-api/get?userId=$USER_ID"  
