...
class TurfLootHathoraClient {
  ...
  mapServerRegionToHathora(serverRegion) {
    ...
    const regionMap = {
      // Full region names mapped to Hathora standard region codes
      'US East': 'us',
      'US-East-1': 'us', 
      'US West': 'usw',
      'Europe': ['eu'], // EU region
      ...
      'Europe (Frankfurt)': 'eu',
      'Europe (London)': 'eu',
      'Oceania': 'asia', // Closest available region to Australia
      'OCE (Sydney)': 'asia',
      'Asia': 'asia',
      ...
      'US': 'us',
      'EU': ['eu'],
      'OCE': 'asia', // Use Asia region for Oceania (Singapore is closest)
      'SEA': 'asia',
      
      // Specific region IDs from server browser mapped to Hathora standard region codes
      'washington-dc': 'us',
      'seattle': 'usw', 
      'los-angeles': 'usw',
      'frankfurt': 'eu',
