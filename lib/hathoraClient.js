...
class TurfLootHathoraClient {
  ...
  async connectToGame(gameConfig = {}) {
    ...
    if (requestedRoomId === 'global-practice-bots') {
      ...
      console.log('🌍 Connecting directly to Hathora server:', socketUrl)
    ...
    // For other room types, use Hathora lobby service only - NO FALLBACKS
    ...
    console.log('✅ Hathora lobby connection established:', {
      socketUrl,
      lobbyId: finalRoomId,
