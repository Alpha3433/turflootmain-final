...
class TurfLootHathoraClient {
  ...
  mapServerRegionToHathora(serverRegion) {
    ...
    const regionMap = {
      // Full region names mapped to AWS regions
      'US East': 'us-east-1',
      'US-East-1': 'us-east-1', 
      'US West': 'us-west-2',
      'Europe': ['eu-central-1', 'eu-west-2'], // Multiple EU regions for better coverage
      'EU': ['eu-central-1', 'eu-west-2'],
      'Europe (Frankfurt)': 'eu-central-1',
      'Europe (London)': 'eu-west-2',
      'Oceania': 'ap-southeast-2',
      'OCE (Sydney)': 'ap-southeast-2',
      'Asia': 'ap-southeast-1',
      ...
      // Specific region IDs from server browser mapped to AWS regions
