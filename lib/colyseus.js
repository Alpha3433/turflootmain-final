...
class TurfLootColyseusClient {
  ...
  setupEventListeners() {
    ...
    this.room.onStateChange((state) => {
      ...
      console.log('*** DEBUGGING *** Players count:', state.players ? Object.keys(state.players).length : 'no players')
      console.log('*** DEBUGGING *** State type:', typeof state)
      
      // Handle players using official Colyseus Cloud documentation approach
      if (state && state.players) {
        console.log('*** DEBUGGING *** Processing players...')
      ...
      if (state && state.coins) {
        console.log('*** DEBUGGING *** State has coins:', state.coins.length)
