...
export class PartySystem {
  ...
  static async createParty(ownerId, ownerUsername, partyName = null) {
    ...
    if (existingParty) {
      throw new Error('You already have an active party. Leave your current party first.')
    }
    ...
    const party = {
      ...
      maxMembers: 4, // Can be configured
    ...
    console.log(`🎉 Party created: ${partyId} by ${ownerUsername}`)
